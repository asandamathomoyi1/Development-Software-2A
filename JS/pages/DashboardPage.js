        ...
        <div style="max-width:1100px;margin:0 auto;">
            ...
            <div style="display:flex;flex-wrap:wrap;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:28px;" class="anim-fadeUp">
                ...
                <div style="display:flex;gap:12px;flex-wrap:wrap;">
                    <button onclick="goto('games')" class="btn-primary" style="padding:11px 20px;border-radius:10px;font-size:14px;cursor:pointer;display:flex;align-items:center;gap:8px;background:linear-gradient(135deg, #a78bfa, #d946ef);">
